...
<head>
    ...
    a.green-city-tooltip {
        position: relative;
        top: 50px;
        left: 50px;
        background: url("/images/ticbox/square-question-ico.png") no-repeat scroll 100% 0 transparent;
        cursor: pointer;
    ...
    a.green-city-tooltip:hover span {
        opacity: 1;
        visibility: visible;
    }

    a.green-city-tooltip span {
        padding: 10px;
        top: 20px;
        min-width: 75px;
        max-width: 150px;
...
<div class="module">
        ...
        <div class="line ">
            <div class="col col-centered enableTooltip">
                <input name="surveyType" data-toggle="tooltip" data-placement="bottom" type="radio"
                       class="surveyType prettyChk" id="freeSurveyChk"
                       data-label="<g:message code="survey.type.free.label"/>" value="${Survey.SURVEY_TYPE.FREE}">
                <input name="surveyType" data-toggle="tooltip" data-placement="bottom" type="radio"
                       class="surveyType prettyChk" id="easySurveyChk"
    ...
    <div id="filterHeader" class="module-header">
        <div class="title">Respondent Filter</div>
    </div>
